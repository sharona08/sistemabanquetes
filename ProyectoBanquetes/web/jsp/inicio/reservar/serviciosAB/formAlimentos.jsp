    ...
    <body>
        ...
        <div id="pageWrap">
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/reservar/serviciosAB/formAlimentos.jsp?idEvento=<%=idEvento%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
                    ...
                    <form method="get" action="crearAB.jsp" class="cmxform" id="commentForm" name="form">
                        <table width="88%" border="0">
                            ...
                            <tr style="height: 40px">
                                <td>Cantidad: (*)</td>
                                <td>
                                    <input class="required" type="text" name="cantidad" value="<%= evento.getCantidadPersonas()%>" style="width: 250px; height: 23px" align="middle" onKeyUp="this.value=this.value.toUpperCase();" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="boton" class="demo" style="float: right; margin-bottom: 20px">
                                        <input class="submit" type="submit" name="create" value="Crear" style="width: 80px; height: 25px; margin-right: 5px" onclick=""/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
