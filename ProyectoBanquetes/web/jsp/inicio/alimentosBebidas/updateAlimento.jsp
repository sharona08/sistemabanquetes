...
<html>
    ...
    <body>
        <div id="pageWrap">
            ...
            <meta HTTP-EQUIV="REFRESH" content="0; url=/ProyectoBanquetes/jsp/inicio/alimentosBebidas/alimentoFiltros.jsp?id=<%=id%>&nombre=<%=nombre%>&mensaje=<%=mensaje%>&texto=<%=texto%>">
