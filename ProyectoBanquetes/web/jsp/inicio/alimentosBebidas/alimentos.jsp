...
<%
            ...
            if (request.getParameter("inhabilitados") != null) {
                if (id == "") {
                    servicios = servicioServicio.listarServiciosTodos(null, nombre, "AB");
                } else {
                    servicios = servicioServicio.listarServiciosTodos(Integer.valueOf(id), nombre, "AB");
                }
            } else {
                if (id == "") {
                    servicios = servicioServicio.listarServiciosHabilitados(null, nombre, "AB");
                } else {
                    servicios = servicioServicio.listarServiciosHabilitados(Integer.valueOf(id), nombre, "AB");
                }
            }
%>
...
<div id="alimento" style="width: 40%; min-height: 300px; background-color: #dadada; padding-left: 20px; padding-top: 20px; padding-right: 10px; padding-bottom: 20px">
