    ...
    <body>
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/alimentosBebidas/alimentoFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/alimentosBebidas/alimentoFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
            ...
            <div id="content">
                ...
                <script type="text/javascript">
                    function includeDivAlimentos()
                    {
                        document.getElementById("alimentos").style.display="block";
                    }

                    function hideDivAlimentos()
                    {
                ...
                <div id="disponibilidad" style="margin-left: 10px">
                    <h1 id="letra1">ALIMENTOS Y BEBIDAS</h1>
                ...
                <div id="alimentos" style="margin-left: 10px">
                    <jsp:include page="alimentos.jsp" flush="true"></jsp:include>
                </div>
            </div>
