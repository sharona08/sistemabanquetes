    ...
    <body>
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/usuarios/usuarioFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>&apellido=<%= apellido%>" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/usuarios/usuarioFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>&apellido=<%= apellido%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
