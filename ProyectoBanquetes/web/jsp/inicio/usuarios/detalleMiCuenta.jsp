    ...
    <body>
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/usuarios/detalleMiCuenta.jsp" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/usuarios/detalleMiCuenta.jsp" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
