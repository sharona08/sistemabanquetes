...
<html>
    ...
    <body>
        ...
        <div id="pageWrap">
            ...
            <div id="content">
                <h1 id="letra1">Crear Audiovisual</h1>
                <%
                String mensaje = "";
                            String texto = "";
            ...
            <meta HTTP-EQUIV="REFRESH" content="0; url=/ProyectoBanquetes/jsp/inicio/audiovisuales/audiovisualFiltros.jsp?mensaje=<%=mensaje%>&texto=<%=texto%>"/>
