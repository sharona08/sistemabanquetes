    ...
    <body>
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/audiovisuales/audiovisualFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/audiovisuales/audiovisualFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
            ...
            <div id="content">
                ...
                <div id="alimentos" style="margin-left: 10px">
                    <jsp:include page="audiovisuales.jsp" flush="true"></jsp:include>
                </div>
            </div>
