...
<%
            ...
            Departamento departamento = servicioDepartamento.getDepartamento(id);

%>

<h1 id="letra2">INFORMACION DEPARTAMENTO # <% out.println(id);%></h1>
<div id="detalle" style="margin-left: 20px; margin-right: 20px; padding-top: 15px" align="center">
    <form method="get" action="updateDepartamento.jsp">
        <table width="80%" border="0">
            <tr style="height: 40px">
                <td width="30%">Nombre:</td>
                <td width="50%">
                    <input value="<%= departamento.getNombre()%>" name="nombreDepartamento" onKeyUp="this.value=this.value.toUpperCase();" style="width: 250px; height: 23px" align="middle" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <div id="boton" class="demo" style="float: left; margin-bottom: 20px">
        <input type="submit" name="cancel" value="Cancelar" onclick="hideDivDepartamento()" style="width: 80px; height: 25px;"/>
    </div>
</div>