...
<div id="detalle" style="margin-left: 20px; margin-right: 20px; padding-top: 15px" align="center">
    <form method="get" action="updateContacto.jsp" class="cmxform" id="commentForm">
        <table width="80%" border="0">
            <tr style="height: 40px">
                <td width="30%">Nombre:</td>
                <td width="50%">
                    <input class="required" value="<%= contacto.getNombre()%>" name="nombreContacto" onKeyUp="this.value=this.value.toUpperCase();" style="width: 250px; height: 23px" align="middle" />
                </td>
            </tr>
            <tr style="height: 40px">
                <td>Telefono:</td>
