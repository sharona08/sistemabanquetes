    ...
    <body>
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/contactos/contactoFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/contactos/contactoFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
            ...
            <div id="content">
                <%
                            ...
                            Boolean checkRif = Boolean.FALSE;
                            if (request.getParameter("rifEmpresa") != null) {
                                checkRif = Boolean.TRUE;
                            } else {
                                checkRif = Boolean.FALSE;
                            }
                %>
                ...
                <div id="empresas" style="margin-left: 10px">
                    <jsp:include page="contactos.jsp" flush="true"></jsp:include>
                </div>
            </div>
