                            ...
                            <tr style="height: 35px">
                                ...
                                <td width="3%">
                                    <div id="boton" class="demo" style="margin-left: 10px; float: left">
                                        ...
                                        <input type="submit" value="Exportar" style="width: 75px; height: 25px;" align="left" onclick="document.form.action='eliminarSalonExpServicio.jsp';document.form.submit();"/>
