        ...
        <div id="pageWrap">
            ...
            <div id="content">
                ...
                <div style="margin-left: 10px; width: 30%">
                    <form action="repServicioMasVendido.jsp" method="get" class="cmxform" id="commentForm">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr style="height: 30px">
                                <td>Servicio </td>
                                <td>
                                    <select name="servicio" style="width: 160px; height: 25px">
                                        <option value="AB">Alimentos y Bebidas</option>
                                        <option value="AU">Equipos Audiovisuales</option>
