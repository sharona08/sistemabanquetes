    ...
    <body>
        ...
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/reservar/serviciosOT/formOtros.jsp?idEvento=<%=idEvento%>" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/reservar/serviciosOT/formOtros.jsp?idEvento=<%=idEvento%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
