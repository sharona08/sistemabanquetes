...
<div id="detalle" style="margin-left: 20px; margin-right: 20px; padding-top: 15px" align="center">
    <form method="get" action="updateDepartamento.jsp">
        <table width="80%" border="0">
            <tr style="height: 30px">
                ...
                <td width="50%">
                    <input value="<%= departamento.getNombre()%>" name="nombreDepartamento" onKeyUp="this.value=this.value.toUpperCase();" style="width: 180px; height: 23px" align="middle" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <div id="boton" class="demo" style="float: left; margin-bottom: 20px">
        <input type="submit" name="cancel" value="Cancelar" onclick="hideDivDepartamento()" style="width: 65px;"/>
    </div>
</div>