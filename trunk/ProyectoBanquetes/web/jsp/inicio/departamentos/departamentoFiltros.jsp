    ...
    <body>
        <div id="pageWrap">
            ...
            <div id="info" style="float: inherit">
                Exito! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/departamentos/departamentoFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            ...
            <div id="info2" style="float: inherit">
                Error! <%=texto%> <a href="/ProyectoBanquetes/jsp/inicio/departamentos/departamentoFiltros.jsp?id=<%=id%>&nombre=<%= nombre%>" class="close">Cerrar</a>
            </div>
            <%                            }
                        }
            %>
            ...
            <div id="content">
                ...
                <script type="text/javascript">
                    function includeDivDepartamentos()
                    {
                        document.getElementById("departamentos").style.display="block";
                    }

                    function hideDivDepartamentos()
                    {
                            ...
                            <tr style="height: 30px">
                                ...
                                <td>
                                    <div id="boton" class="demo">
                                        <input type="submit" name="ok" value="Ok" style="width: 35px; height: 25px;" align="middle" onclick="includeDivDepartamentos()"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                ...
                <div id="departamentos" style="margin-left: 10px">
                    <jsp:include page="departamentos.jsp" flush="true"></jsp:include>
                </div>
            </div>
