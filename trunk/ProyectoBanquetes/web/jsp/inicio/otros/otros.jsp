...
<script type="text/javascript">
    function includeDivOtro()
    {
        document.getElementById("otro").style.display="block";
    }

    function hideDivOtro()
    {
...
<%
            ...
            if (request.getParameter("inhabilitados") != null) {
                if (id == "") {
                    servicios = servicioServicio.listarServiciosTodos(null, nombre, "OT");
                } else {
                    servicios = servicioServicio.listarServiciosTodos(Integer.valueOf(id), nombre, "OT");
                }
            } else {
                if (id == "") {
                    servicios = servicioServicio.listarServiciosHabilitados(null, nombre, "OT");
                } else {
                    servicios = servicioServicio.listarServiciosHabilitados(Integer.valueOf(id), nombre, "OT");
                }
            }
%>
...
<div id="result" style="margin-right: 10px">
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr align="center" bgcolor="#FF8080">
                ...
                <td>
                    <div id="boton" class="demo">
                        ...
                        <%}%>
                        <input type="submit" name="editar" value="Editar" style="width: 65px; margin-top: 1px; margin-bottom: 1px;" onclick="includeDivOtro()"/>
                    </div>
                </td>
            </tr>
        </form>
        ...
        <tr>
            ...
            <td align="center">
                <div id="boton" class="demo">
                    <input type="submit" name="crear" value="Nuevo" style="width: 65px; margin-top: 1px; margin-bottom: 1px;" onclick="redirect('formCrearOtro.jsp')"/>
                </div>
            </td>
        </tr>
    </table>
...
<div id="otro" style="width: 40%; min-height: 300px; background-color: #dadada; padding-left: 20px; padding-top: 20px; padding-right: 20px; padding-bottom: 20px">
    <jsp:include page="detalleOtro.jsp"></jsp:include>
</div>
